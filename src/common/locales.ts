...
export const zh_cn = new Map<LocaleKey, string>([
  ...
  [
    "deeplxConfigNote",
    "填写完整可请求的 DeepLX 地址，例如 https://example.com/<token>/translate",
  ],
...
export const en = new Map<LocaleKey, string>([
  ...
  [
    "deeplxConfigNote",
    "Enter the full DeepLX request URL, for example https://example.com/<token>/translate",
  ],
  ["deeplxUrl", "DeepLX URL"],
  ...
  [
    "<tooltip>deeplx",
    "Use a third-party hosted or self-hosted DeepLX translation endpoint",
  ],
