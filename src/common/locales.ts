...
export const zh_cn = new Map<LocaleKey, string>([
  ...
  ["<tooltip>keyan", "棵岩翻译引擎，CopyTranslator与棵岩翻译有合作，默认不需要填写API密钥，如需自定义可自行填写"],
  ["<tooltip>stepfun", "阶跃星辰翻译引擎，CopyTranslator与阶跃星辰有合作，默认不需要填写API密钥，如需自定义可自行填写"],
  ["keyanSlogan", "来⾃棵岩翻译 免费⼀键翻译全⽂>>>"],
  ["stepfunSlogan", "来自阶跃星辰 AI 服务>>>"],
  ...
  ["noCustomTranslators", "暂无自定义翻译器"],
  // 供应商管理
  ["providers", "翻译供应商"],
  ["addProvider", "添加供应商"],
  ["editProvider", "编辑供应商"],
  ["providerName", "供应商名称"],
  ["selectProviderTemplate", "选择供应商模板"],
  ["noProviders", "尚未添加翻译供应商"],
...
export const en = new Map<LocaleKey, string>([
  ...
  ["stepfunSlogan", "From Stepfun AI Services>>>"],
  ...
  ["customTranslators", "Custom Translators"],
  ...
  ["noCustomTranslators", "No custom translators yet"],
  // Provider management
  ["providers", "Translation Providers"],
  ["addProvider", "Add Provider"],
  ["editProvider", "Edit Provider"],
  ["providerName", "Provider Name"],
  ["selectProviderTemplate", "Select Provider Template"],
